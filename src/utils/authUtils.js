...
export async function signInUserWithGoogle(selectedRole) {
  ...
  if (user.uid) {
    ...
    try {
      ...
      console.error('Firestore access error during Google Sign-In:', error)
      if (error.code === 'permission-denied' || (error.message && error.message.includes('permission'))) {
        throw new Error('Firestore permission denied. Please publish the Firestore Security Rules in your Firebase Console (see firestore-rules.txt).')
      }
      throw error
    }
  }
